...
.tg .tg-7dqm{font-weight:bold;font-family:Arial, Helvetica, sans-serif !important;;text-align:center;vertical-align:top}
.tg .tg-zsu9{font-family:Arial, Helvetica, sans-serif !important;;vertical-align:top}
	...
	<h2>곡 리뷰 쓰기</h2>
		<table class="tg" style="width:100%;">
		  ...
		  <tr>
		    ...
		    <td class="tg-zsu9" colspan="4"><textarea class="form-control" rows="15" name="comment" style="width:100%; resize:none;" placeholder="솔직한 상품평을 써달라능"></textarea></td>
		  </tr>
		</table>
	</div>
	<div align="right">
