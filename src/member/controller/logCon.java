...
public class logCon {
	...
	public ModelAndView proceed(HttpSession session, @RequestParam(name = "id") String id, String pass, String idcheck,
		...
		if (rst == 1) {
			...
			mav.setViewName("redirect:/index"); // redirect: 경로는 뷰설정이 애초에 다른
												// 매핑잡아둔 경로로 요청 전환
		} else {
